...
def to_matrix_complete(vector_params):
    ...
    sin_psi = -torch.sqrt(1-(cos_psi**2))
...
def OnePlusOne(Ref_uint8_ravel, Flt_uint8, eref, parent,volume):
    ...
    for i in range (0,m_MaximumIteration):
        ...
        cvalue = compute_mi(Ref_uint8_ravel, Flt_uint8, to_cuda(childPosition), eref,compute_mi)
...
def register_images(filename,Ref_uint8, Flt_uint8,volume):
    ...
    optimal_params = OnePlusOne(Ref_uint8_ravel, Flt_uint8, eref, parent,volume) 
